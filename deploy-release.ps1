...
$buildDir = Join-Path $repoRoot 'bin\release\Contents'
$packageContents = Join-Path $repoRoot 'bin\release\PackageContents.xml'
...
Write-Host "Deployed release add-in to: $targetAddin"
